...
namespace Inva.LawMax.Migrations
{
    ...
    [Migration("20240715193249_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inva.LawMax.Entity.Case", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.Property<int>("LitigationDegree")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Inva.LawMax.Entity.Hearing", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inva.LawMax.Entity.Lawyer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inva.LawMax.Entity.Case", b =>
                {
                    b.HasOne("Inva.LawMax.Entity.Lawyer", "Lawyer")
                        .WithMany("Cases")
            ...
            modelBuilder.Entity("Inva.LawMax.Entity.Hearing", b =>
                {
                    b.HasOne("Inva.LawMax.Entity.Case", "Case")
                        .WithMany("Hearings")
